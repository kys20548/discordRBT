...
import com.kys.robot001.Robot001Application;
...
public class PingPongRBT {


    private static final Long serverId = 123L;// me server
    private static final Long ownerId = 123L;// me
    //private static final Long serverId = ***;// yixian server
    //private static final Long ownerId = ****;// yixian
    ...
    public static void main(String[] args) {
        ...
        DiscordApi api = new DiscordApiBuilder()
                .setToken("OTU3ODc1MTI0OTM2MjQ1MjU4.YkFIug.A09sioSH-opW0c7Oj1KwSB1IBMg")
                .setAllIntents()
                .login().join();
